...
const Skincare = () => {
  return (
    <div className="grid grid-cols-2 px-[100px] gap-[100px] mt-[100px]">
      <div className="">
        <div>
          ...
          <h1 className="text-[60px] mt-[20px] leading-[60px]">YOUR SKIN DESERVES THE BEST CARE.</h1>
      ...
      <div className="className=w-[850px] h-[1080px] ">
